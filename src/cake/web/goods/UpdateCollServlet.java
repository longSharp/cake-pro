 ...
 * @create 2020-10-29
 */
@WebServlet(name = "UpdateCollServlet")
public class UpdateCollServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = goodsService.updateCarColl(Integer.parseInt(coll), Integer.parseInt(goods_id), Integer.parseInt(user_id),specifi);
